...
export function VoicePanel(props: VoicePanelProps) {
  ...
  return (
    <div class="w-72 portrait:w-full bg-gray-800/50 p-5 border-l border-t-0 portrait:border-t portrait:border-l-0 border-gray-700 flex flex-col shrink-0">
      {/* 操作ボタン */}
      <div class="flex gap-2 mb-5">
        <Show
          ...
          fallback={
            <button
              class="flex-1 bg-blue-600 hover:bg-blue-500 text-white py-2 portrait:py-3 rounded-lg text-sm portrait:text-base font-bold transition-colors shadow-lg shadow-blue-900/20"
        ...
        >
          <button
            class="flex-1 bg-gray-700 hover:bg-gray-600 text-white py-2 portrait:py-3 rounded-lg text-sm portrait:text-base font-medium transition-colors"
      ...
      {/* スクロール可能なユーザーリスト */}
      <div class="flex-1 overflow-y-auto pr-1 custom-scrollbar max-h-none portrait:max-h-36">
